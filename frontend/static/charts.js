...
// start check mobile browser logic
...
try {
    allowZooming = !isMobileResolution();
} catch(err) {
    console.log("error during mobile resolution detection!");
}
// end check mobile browser logic
...
$.getJSON("/api/v1/statistics/agencies/", function (data) {
    ...
    c3.generate({
        ...
        zoom: {
            enabled: allowZooming,
            rescale: allowZooming
        },
        axis: {
            x: {
                type: 'category',// this needed to load string x value
